...
public class UsuarioPutFunction {
        ...
        public HttpResponseMessage updateUsuario(
                        @HttpTrigger(name = "req", methods = {
                                        HttpMethod.PUT }, route = "usuarios/{id:int}", authLevel = AuthorizationLevel.ANONYMOUS) HttpRequestMessage<Optional<String>> request,
                        @BindingName("id") int id,
                        final ExecutionContext context) {

                // informo que voy a actualizar un usuario por su id
                ...
                try {
                        ...
                        // preparo Gson para convertir el JSON recibido a objeto Usuario
                        Gson gson = new Gson();
                        Usuario usuario = gson.fromJson(body, Usuario.class);

                        // valido si no pude leer correctamente el usuario enviado
                        if (usuario == null) {
                        ...
                        // creo el repositorio para actualizar el usuario
                        ...
                        // valido si no existía un usuario con ese id
                        ...
                        // convierto el usuario actualizado a JSON
                        String json = gson.toJson(usuarioActualizado);

                        // evuelvo una respuesta correcta con el usuario actualizado
                        ...
                        // controlo el caso en que el JSON venga mal escrito
                        ...
                        // controlo cualquier otro error general
